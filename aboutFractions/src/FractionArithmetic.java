...
public class FractionArithmetic {
  ...
  public static void showIntroduction() {
    ...
    System.out.printf(
        "%931s%4s%5s",
        "SOLLORIN, John Michael A.",
        " - ",
        "2201333\n");
    System.out.printf(
        "%94s%2s%5s",
        "TADENA, Princess Brylle N.",
        " - ",
        "2234832\n");
  ...
  public static void addFraction(Fraction fractionOne, Fraction fractionTwo) {
    ...
    System.out.printf(
        "\n%68s%s%s%s%s%s%.4f",
        fractionOne.toString(),
        " + ",
        fractionTwo.toString(),
        " is equal to ",
        result.toString(),
        " or ",
        deciVal);
  ...
  public static void reduceFraction(
      Fraction fractionOne,
      Fraction fractionTwo) {
    Fraction resultOne = fractionOne.reduce(
        fractionOne.getNumerator(),
        fractionOne.getDenominator());
    Fraction resultTwo = fractionTwo.reduce(
